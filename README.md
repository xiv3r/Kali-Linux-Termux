...
- Auto Install
      ...
      termux-setup-storage && apt update && apt upgrade -y && apt install wget && wget -qO- https://raw.githubusercontent.com/xiv3r/Kali-Linux-Termux/refs/heads/main/install.sh | sh && ./install-nethunter-termux
